...
# label
label = ttk.Label(frame,  text='Linha, Circulo ou Rabisco:')
label.grid(column=0, row=0, sticky=W, **paddings)

# option menu
tipo_figura_var = StringVar(root) # Guarda o tipo de figura selecionado no option menu (linha ou rabisco e agora circulo tb)
option_menu = ttk.OptionMenu(frame, tipo_figura_var,
                             'Linha', 'Linha', 'Rabisco', "Circulo") #aq linha é repetida pq é exigido deixar a opção padrão duas vezes
